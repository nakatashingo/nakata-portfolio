...
const WorksSection = ({ items }: WorksSectionProps) => (
  <section id="works" className="px-8 py-22">
    <div className="mx-auto max-w-[1080px]">
      <Reveal>
        <h1 className="m-0 mb-2 text-center text-3xl font-extrabold tracking-[-0.02em]">Works</h1>
        <p className="m-0 mb-12 text-center text-[0.9375rem] text-gray-400">
          ※ 実プロジェクトへ差し替え予定のプレースホルダーです
        </p>
      </Reveal>
      <Reveal delay={0.1}>
